document.addEventListener("DOMContentLoaded", function() {
    const allowedColumns = ["AerWon%", "Min", "Goals", "Age", "MP", "90s", "Starts", "PasTotCmp%", "Assists", "Blocks", "Int", "Tkl+Int", "Fls", "Recov", "Shots", "SoT", "SoT%", "PasShoCmp%", "PasMedCmp%", "PasLonCmp%", "Pas3rd", "GCA", "Touches", "PKwon", "Fld", "Crs", "SCA", "G/Sh", "G/SoT", "ToSuc", "ToSuc%" ];
    const allowedHistogramColumns = ["AerWon%", "Min", "Goals", "Age", "MP", "90s", "Starts", "PasTotCmp%", "Assists", "Blocks", "Int", "Tkl+Int", "Fls", "Recov", "Shots", "SoT", "SoT%", "PasShoCmp%", "PasMedCmp%", "PasLonCmp%", "Pas3rd", "GCA", "Touches", "PKwon", "Fld", "Crs", "SCA", "G/Sh", "G/SoT", "ToSuc", "ToSuc%" ];
    const defaultX = "SoT%";
    const defaultY = "Goals";
    const defaultSize = "Min";
    const defaultHistogram = "G/Sh";
